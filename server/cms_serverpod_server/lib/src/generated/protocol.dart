...
import 'error_detail.dart' as _i4;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.ErrorDetail) {
      return _i4.ErrorDetail.fromJson(data) as T;
    }
    if (t == _i5.Example) {
    ...
    if (t == _i1.getType<_i4.ErrorDetail?>()) {
      return (data != null ? _i4.ErrorDetail.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.Example?>()) {
      return (data != null ? _i5.Example.fromJson(data) : null) as T;
    }
    if (t == List<_i4.ErrorDetail>) {
      return (data as List).map((e) => deserialize<_i4.ErrorDetail>(e)).toList()
          as dynamic;
    }
    try {
  ...
  String? getClassNameForObject(Object? data) {
    ...
    if (data is _i3.ApiException) {
      return 'ApiException';
    }
    if (data is _i4.ErrorDetail) {
      return 'ErrorDetail';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ErrorDetail') {
      return deserialize<_i4.ErrorDetail>(data['data']);
    }

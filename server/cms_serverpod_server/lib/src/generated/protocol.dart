...
import 'error_detail.dart' as _i5;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i5.ErrorDetail) {
      return _i5.ErrorDetail.fromJson(data) as T;
    }
    if (t == _i6.Example) {
    ...
    if (t == _i1.getType<_i5.ErrorDetail?>()) {
      return (data != null ? _i5.ErrorDetail.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i5.ErrorDetail>) {
      return (data as List).map((e) => deserialize<_i5.ErrorDetail>(e)).toList()
          as dynamic;
    }
    try {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'ErrorDetail') {
      return deserialize<_i5.ErrorDetail>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'cms_serverpod';
}
